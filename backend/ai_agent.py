...
@tool
def ask_mentalt_health_specialist(query: str) -> str:

    """
    Generate a Therapeutic response using the medgemma model.
    Use this tool for all general queries related to mental health, emotional support, 
    and therapeutic advice.
    or to offer empathetic listening and guidance in conversational tone.
    """
...
def emergency_call_tool(phone: str) -> str:
    """
    Placed an emergancy call to the safety helplines phone number via Twilio.
    use this only if the user expresses suicidal thoughts or self-harm intentions.
    or describe a mental health emergency help.
    """
    return call_emergency_contact(phone)


# Siddhu edit this code you can used duckduckgo search tool or any other tool
@tool
...
#step4 - create an ai agent and link to backend
...
tools = [ask_mentalt_health_specialist, emergency_call_tool, find_nearby_therapists_by_location]
